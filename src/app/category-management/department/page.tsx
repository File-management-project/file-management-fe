...
import positionData from "@/data/departmentData.json";
import AddPanel from "@/components/common/AddPanel";
import Filter from "@/components/common/Filter";
import formFields from "@/data/departmentForm.json";
    ...
    <div>
      <LayoutWeb breadCrumbs={breadCrumbs}>
        <div className="p-4 h-full bg-gray-50">
          <h1 className="text-displaySm text-gray-950">Đơn vị / Phòng ban</h1>
